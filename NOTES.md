...
## About the learner
- Complete beginner to plant care theory, but already has plants
- Lives in Adelaide, SA — Mediterranean climate, hot summers
- Setup: house, master bedroom with large openable window + curtains, easy outdoor access
- Learning for personal enjoyment, spare time
...
- Ficus elastica cutting (刚刚 top) — soil prop, June 2026. Use 50/50 potting mix + perlite + rooting powder if not already applied.
...
## Locations
1. Balcony — 1st floor, off master bedroom, no rain cover. Spring/summer mild days only.
2. Master bedroom — next to 落地窗 (bright indirect, trees outside naturally filter light — ideal)
3. Master bedroom — next to window with curtain shade (medium indirect)
4. Master bedroom — corner (low-medium)
5. Family room / living room — ground floor, next to window = bright-ish (Lili is here). Spider is now outside.
6. Bathroom — high humidity from shower (good for Calatheas)
7. Alfresco — ground floor, FULLY ROOFED (4.0 x 6.6m), open sides, ground level. Rain-protected outdoor space. Best spring/summer plant staging area.

## Key observations from photos
- Master bedroom 落地窗: trees directly outside naturally filter light — bright indirect already softened, no curtain needed in most conditions
- Alfresco has full roof cover — prime outdoor plant location from September, protected even in light rain
- Balcony (1st floor) has no roof — unsuitable in rain or cold
- Ceiling fan in master bedroom — good for air circulation

## Window info
- Master bedroom: 落地窗 (floor-to-ceiling window), north-facing — best possible orientation in Australia
- Winter: low sun angle means direct light penetrates deep into the room — great for plants further back
- Summer: sun angle higher, less direct penetration — still very bright indirect all day
- Has curtains — essential in summer (Dec–Feb) to block harsh direct rays
- Can open window — rainy Adelaide winters bring 70–80% humidity, beneficial for Calatheas

## Teaching approach
- Ground every lesson in her specific plants and her specific room setup
- Short, practical lessons with immediate wins
- Adelaide climate context matters — flag seasonal care differences
